...
class _GroupPermissionEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _GroupPermission.ValueType
    ],
    builtins.type,
):
...
class JoinedGroup(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        acl: global___GroupACL | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["acl", b"acl", "groupInfo", b"groupInfo"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["acl", b"acl", "groupInfo", b"groupInfo"],
...
class RegisterOptions(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        credentials: global___WUCredentials | None = ...,
        defaultGroupPermission: global___GroupPermission.ValueType = ...
    ) -> None: ...
    def HasField(
...
class GroupACL(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["JID", b"JID", "updatedAt", b"updatedAt"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class DisappearingMessageOptions(google.protobuf.message.Message):
    ...
    class _DISAPPEARING_TIMEEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DisappearingMessageOptions._DISAPPEARING_TIME.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class DISAPPEARING_TIME(
        _DISAPPEARING_TIME, metaclass=_DISAPPEARING_TIMEEnumTypeWrapper
    ): ...
    ...
    def __init__(
        self,
        *,
        recipient: global___JID | None = ...,
        disappearingTime: global___DisappearingMessageOptions.DISAPPEARING_TIME.ValueType = ...,
        autoClearTime: builtins.int = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["recipient", b"recipient"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class SendMessageOptions(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        recipient: global___JID | None = ...,
        simpleText: builtins.str = ...,
        sendMessageMedia: global___SendMessageMedia | None = ...,
        rawMessage: whatsappweb_pb2.Message | None = ...,
        composingTime: builtins.int = ...
    ) -> None: ...
    def HasField(
        self,
    ...
    def WhichOneof(
        ...
        typing_extensions.Literal["simpleText", "sendMessageMedia", "rawMessage"] | None
    ): ...
...
class SendMessageMedia(google.protobuf.message.Message):
    ...
    class _MediaTypeEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            SendMessageMedia._MediaType.ValueType
        ],
        builtins.type,
    ):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class DownloadMediaOptions(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        mediaMessage: whatsappweb_pb2.Message | None = ...,
        info: global___MessageInfo | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "info", b"info", "mediaMessage", b"mediaMessage"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class PendingHistoryOptions(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "historyReadTimeout", b"historyReadTimeout"
        ],
    ) -> None: ...
...
class SendMessageReceipt(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        sentAt: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        messageId: builtins.str = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["sentAt", b"sentAt"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "messageId", b"messageId", "sentAt", b"sentAt"
        ],
    ) -> None: ...
...
class GroupName(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "name", b"name", "updatedAt", b"updatedAt", "updatedBy", b"updatedBy"
        ],
    ) -> None: ...
...
class GroupParticipant(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal["JID", b"JID", "contact", b"contact"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class GroupInfo(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        parentJID: global___JID | None = ...,
        provenance: collections.abc.Mapping[builtins.str, builtins.str] | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class MessagesOptions(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal["markMessagesRead", b"markMessagesRead"],
    ) -> None: ...
...
class SessionToken(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        token: builtins.str = ...,
        expirationTime: google.protobuf.timestamp_pb2.Timestamp | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["expirationTime", b"expirationTime"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "expirationTime", b"expirationTime", "token", b"token"
        ],
    ) -> None: ...
...
class RegisterMessages(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        qrcode: builtins.str = ...,
        loggedIn: builtins.bool = ...,
        token: global___SessionToken | None = ...
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "loggedIn", b"loggedIn", "qrcode", b"qrcode", "token", b"token"
        ],
    ) -> None: ...
...
class WUCredentials(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, username: builtins.str = ..., passphrase: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "passphrase", b"passphrase", "username", b"username"
        ],
    ) -> None: ...
...
class ConnectionStatus(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        JID: global___JID | None = ...,
        JIDAnon: global___JID | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "JID", b"JID", "JIDAnon", b"JIDAnon", "timestamp", b"timestamp"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class WUMessage(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        messageProperties: global___MessageProperties | None = ...,
        provenance: collections.abc.Mapping[builtins.str, builtins.str] | None = ...,
        originalMessage: whatsappweb_pb2.Message | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class MessageSource(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        reciever: global___JID | None = ...,
        senderContact: global___Contact | None = ...,
...
class MessageInfo(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        source: global___MessageSource | None = ...,
        timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        id: builtins.str = ...,
        pushName: builtins.str = ...,
        type: builtins.str = ...,
    ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "source", b"source", "timestamp", b"timestamp"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MessageContent(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        link: builtins.str = ...,
        thumbnail: builtins.bytes = ...,
        mediaMessage: global___MediaMessage | None = ...,
        inReferenceToId: builtins.str = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing_extensions.Literal["mediaMessage", b"mediaMessage"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
...
class MediaMessage(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        imageMessage: whatsappweb_pb2.ImageMessage | None = ...,
        videoMessage: whatsappweb_pb2.VideoMessage | None = ...,
        audioMessage: whatsappweb_pb2.AudioMessage | None = ...,
        documentMessage: whatsappweb_pb2.DocumentMessage | None = ...,
        stickerMessage: whatsappweb_pb2.StickerMessage | None = ...,
        reactionMessage: whatsappweb_pb2.ReactionMessage | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
