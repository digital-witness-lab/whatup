...
const (
	...
	WhatUpCore_GetCommunityInfo_FullMethodName           = "/protos.WhatUpCore/GetCommunityInfo"
	WhatUpCore_GetGroupInvite_FullMethodName             = "/protos.WhatUpCore/GetGroupInvite"
	...
	WhatUpCore_RequestChatHistory_FullMethodName         = "/protos.WhatUpCore/RequestChatHistory"
...
func (c *whatUpCoreClient) GetJoinedGroups(ctx context.Context, in *GetJoinedGroupsOptions, opts ...grpc.CallOption) (WhatUpCore_GetJoinedGroupsClient, error) {
	stream, err := c.cc.NewStream(ctx, &WhatUpCore_ServiceDesc.Streams[0], WhatUpCore_GetJoinedGroups_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *whatUpCoreClient) GetCommunityInfo(ctx context.Context, in *JID, opts ...grpc.CallOption) (WhatUpCore_GetCommunityInfoClient, error) {
	stream, err := c.cc.NewStream(ctx, &WhatUpCore_ServiceDesc.Streams[1], WhatUpCore_GetCommunityInfo_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *whatUpCoreClient) GetGroupInvite(ctx context.Context, in *JID, opts ...grpc.CallOption) (*InviteCode, error) {
	out := new(InviteCode)
	err := c.cc.Invoke(ctx, WhatUpCore_GetGroupInvite_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *whatUpCoreClient) RequestChatHistory(ctx context.Context, in *HistoryRequestOptions, opts ...grpc.CallOption) (*GroupInfo, error) {
	out := new(GroupInfo)
	err := c.cc.Invoke(ctx, WhatUpCore_RequestChatHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WhatUpCore_GetGroupInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WhatUpCore_GetGroupInvite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WhatUpCore_RequestChatHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WhatUpCore_RequestChatHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
